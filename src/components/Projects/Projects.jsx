    ...
    return (
        ...
        <div className="md:flex items-center">
            <div className="md:w-1/2 ml-5 mr-5">
                ...
                <img src="./assets/gymgo.jpg" alt="" className="md:ml-20 mt-2 rounded-full h-28 md:w-40 hover:scale-110" />
                </a>
            {/* </div> */}
            {/* <div className="md:w-1/3 md:ml-6">  */}
                ...
                <p className="font-handjet text-white font-bold text-lg animate-fade-in-y">Es una aplicación web que optimiza la gestión de gimnasios modernos, destacando por su enfoque flexible y cómodo. Esta plataforma brinda a administradores y usuarios una experiencia fitness única.</p>
            </div>
            <div className=" md:w-1/2 ml-5 mr-5 mt-6">
                ...
                <img src="./assets/pifood.jpg" alt="" className="md:ml-20 mt-2 rounded-full h-28 md:w-40 hover:scale-110" />
                </a>
            {/* </div> */}
